...
namespace EXAM
{
    ...
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            int level = 1;//уровень подземелья
            ...
            enemy skeleton = new enemy("Скелет", 25, 5, skeleton_inv);
            enemy rat = new enemy("Крыса", 15, 1, rat_inv);
            enemy elf = new enemy("Эльф", 50, 10, elf_inv);
            ...
            Console.ReadKey();
            Console.Clear();
            Console.WriteLine($"Вы находитесь на {level} уровне подземелья");
            while (true)
            {
                Console.Clear();
                menu();
            ...
            void menu()
            {
                ...
                switch (Convert.ToInt32(Console.ReadLine()))
                {
                    ...
                    case 4:
                        ...
                        Console.WriteLine("ТРУС! ТЫ НЕ МОЖЕШЬ ПОКИНУТЬ ПОДЗЕМЕЛЬЕ, ПОКА НЕ УБЬЁШЬ БОССА, КОТОРЫЙ БУДЕТ ДОБАВЛЕН " +
                            "В СЛЕДУЮЩЕМ ОБНОВЛЕНИИ! ТЫ УМРЁШЬ И БУДЕШЬ ГОРЕТЬ В АДУ!!!");
                    ...
                    case 5:
                        ...
                        while (true)
                        {
                            ...
                            switch (Console.ReadKey().Key)
                            {
                                ...
                                case ConsoleKey.Escape:
                                    ...
                                    break;
                                default:
                                    Console.WriteLine("Управление по инвентарю происходит с помощью стрелок вверх и вниз, нажмите escape чтобы выйти");
                                    Console.ReadKey();
                                    break;
                            }
                            Console.Clear();
                        ...
                        break;
                    case 6:
                        Console.WriteLine("Вы можете перековать 3 одинаковых предмета в один\n" +
            ...
            bool fight(enemy enemy) //если возвращает false, то игрок умер, если true, то выжил
            {
                while (true)
                {
                    ...
                    {
                        Console.WriteLine($"\nВы наносите {enemy.name}у удар своим {player.inventory.equipped.name}," +
